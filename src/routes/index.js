  ...
  return useRoutes([
    ...
    // Dashboard Routes
    {
      ...
      children: [
        ...
        // Notifications
        { path: "notifications", element: <NotificationDirectory /> },
        { path: "notifications/:id", element: <NotificationProfile /> },
      ],
    },
...
// Staff
const StaffDirectory = Loadable(
  lazy(() => import("../pages/dashboard/staff/StaffDirectory"))
);
const StaffProfile = Loadable(
  lazy(() => import("../pages/dashboard/staff/StaffProfile"))
);
const StaffCreate = Loadable(
  lazy(() => import("../pages/dashboard/staff/StaffCreate"))
);

// Routes
const RouteDirectory = Loadable(
  lazy(() => import("../pages/dashboard/routes/RouteDirectory"))
);
const RouteProfile = Loadable(
  lazy(() => import("../pages/dashboard/routes/RouteProfile"))
);
const RouteCreate = Loadable(
  lazy(() => import("../pages/dashboard/routes/RouteCreate"))
);

// Vehicles
const VehicleDirectory = Loadable(
  lazy(() => import("../pages/dashboard/vehicles/VehicleDirectory"))
);
const VehicleProfile = Loadable(
  lazy(() => import("../pages/dashboard/vehicles/VehicleProfile"))
);
const VehicleCreate = Loadable(
  lazy(() => import("../pages/dashboard/vehicles/VehicleCreate"))
);

// Notifications
const NotificationDirectory = Loadable(
  lazy(() => import("../pages/dashboard/notifications/NotificationDirectory"))
);
const NotificationProfile = Loadable(
  lazy(() => import("../pages/dashboard/notifications/NotificationProfile"))
);

// Main
const LandingPage = Loadable(
  lazy(() => import("../pages/external/LandingPage"))
);
