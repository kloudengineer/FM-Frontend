...
export default function StaffNewForm({ isEdit, staff, handleUserCreate }) {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting, resetForm, setErrors }) => {
      try {
        setSubmitting(true);
        // await dispatch(
        //   isEdit ? updateStaff(staff._id, values) : createStaff(values)
        // );
                      ...
                      <Stack spacing={3}>
                          ...
                          <TextField
                            ...
                            error={Boolean(
                              getIn(
                                ...
                                getIn(errors, `address.${index}.streetAddress1`)
                            )}
                            helperText={
                              getIn(
                                touched,
                          ...
                          <TextField
                            ...
                            error={Boolean(
                              getIn(
                                ...
                                getIn(errors, `address.${index}.streetAddress2`)
                            )}
                            helperText={
                              getIn(
                                touched,
                        ...
                        >
                          ...
                          <TextField
                            ...
                            error={Boolean(
                              getIn(touched, `address.${index}.zipCode`) &&
                        ...
                        >
                          <TextField
                            ...
                            error={Boolean(
                              getIn(touched, `address.${index}.moveInDate`) &&
                                getIn(errors, `address.${index}.moveInDate`)
                            )}
                            helperText={
                              getIn(touched, `address.${index}.moveInDate`) &&
                              getIn(errors, `address.${index}.moveInDate`)
                          ...
                          <TextField
                            ...
                            error={Boolean(
                              getIn(touched, `address.${index}.moveOutDate`) &&
                                getIn(errors, `address.${index}.moveOutDate`)
                            )}
                            helperText={
                              getIn(touched, `address.${index}.moveOutDate`) &&
                              getIn(errors, `address.${index}.moveOutDate`)
              ...
              <Stack spacing={3}>
                ...
                >
                  <TextField
                    ...
                    error={Boolean(
                      getIn(touched, `license.number`) &&
                        getIn(errors, `license.number`)
                    )}
                    helperText={
                      getIn(touched, `license.number`) &&
                      getIn(errors, `license.number`)
                  ...
                  <TextField
                    ...
                    error={Boolean(
                      getIn(touched, `license.state`) &&
                        getIn(errors, `license.state`)
                    )}
                    helperText={
                      getIn(touched, `license.state`) &&
                      getIn(errors, `license.state`)
                ...
                >
                  <TextField
                    ...
                    error={Boolean(
                      getIn(touched, `license.issueDate`) &&
                        getIn(errors, `license.issueDate`)
                    )}
                    helperText={
                      getIn(touched, `license.issueDate`) &&
                      getIn(errors, `license.issueDate`)
                  ...
                  <TextField
                    ...
                    error={Boolean(
                      getIn(touched, `license.expiryDate`) &&
                        getIn(errors, `license.expiryDate`)
                    )}
                    helperText={
                      getIn(touched, `license.expiryDate`) &&
                      getIn(errors, `license.expiryDate`)
              ...
              <Stack spacing={3}>
                ...
                >
                  <TextField
                    ...
                    error={Boolean(
                      getIn(touched, `medicalCard.issueDate`) &&
                        getIn(errors, `medicalCard.issueDate`)
                    )}
                    helperText={
                      getIn(touched, `medicalCard.issueDate`) &&
                      getIn(errors, `medicalCard.issueDate`)
                  ...
                  <TextField
                    ...
                    error={Boolean(
                      getIn(touched, `medicalCard.expiryDate`) &&
                        getIn(errors, `medicalCard.expiryDate`)
                    )}
                    helperText={
                      getIn(touched, `medicalCard.expiryDate`) &&
                      getIn(errors, `medicalCard.expiryDate`)
                      ...
                      <Stack spacing={3}>
                        ...
                        >
                          <TextField
                            ...
                            helperText={
                              ...
                              getIn(errors, `workHistory.${index}.companyName`)
                            }
                          />
                          <TextField
                            fullWidth
                            label="Address"
                            {...getFieldProps(
                              `workHistory.${index}.companyAddress`
                            )}
                            error={Boolean(
                              getIn(
                                touched,
                        ...
                        >
                          <TextField
                            ...
                            error={Boolean(
                              getIn(touched, `workHistory.${index}.position`) &&
                                getIn(errors, `workHistory.${index}.position`)
                            )}
                            helperText={
                              getIn(touched, `workHistory.${index}.position`) &&
                              getIn(errors, `workHistory.${index}.position`)
                          ...
                          <TextField
                            ...
                            error={Boolean(
                              getIn(
                                touched,
                                `workHistory.${index}.startDate`
                              ) &&
                                getIn(errors, `workHistory.${index}.startDate`)
                            )}
                            helperText={
                              getIn(
                                touched,
                          ...
                          <TextField
                            ...
                            error={Boolean(
                              getIn(touched, `workHistory.${index}.endDate`) &&
                                getIn(errors, `workHistory.${index}.endDate`)
                            )}
                            helperText={
                              getIn(touched, `workHistory.${index}.endDate`) &&
                              getIn(errors, `workHistory.${index}.endDate`)
                        ...
                        >
                          <TextField
                            ...
                            {...getFieldProps(
                              `workHistory.${index}.referenceName`
                            )}
                            error={Boolean(
                              getIn(
                                touched,
                          ...
                          <TextField
                            ...
                            {...getFieldProps(
                              `workHistory.${index}.referencePhone`
                            )}
                            error={Boolean(
                              getIn(
                                touched,
                          ...
                          <TextField
                            ...
                            {...getFieldProps(
                              `workHistory.${index}.referenceEmail`
                            )}
                            error={Boolean(
                              getIn(
                                touched,
